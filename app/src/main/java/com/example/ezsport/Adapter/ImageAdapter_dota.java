...
public class ImageAdapter_dota extends RecyclerView.Adapter<ImageAdapter_dota.ImageViewHolder> {
    private Context mContext;
    private List<Upload_Info> mUploads;

    public ImageAdapter_dota (Context context,List<Upload_Info> uploads){
        mContext = context;
        mUploads = uploads;
    ...
    public ImageViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.image_item_dota,viewGroup,false);
